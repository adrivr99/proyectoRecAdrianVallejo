...
import static proyecto2.ServicioLectura.*;
...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Empresa empresa = new Empresa("Rocket Mouse", "B - 76365789", "Avenida Espa�a, 10 La L�nea de la Concepci�n, Espa�a", 956202122);
